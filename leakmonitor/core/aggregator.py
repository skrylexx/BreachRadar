"""
leakmonitor/core/aggregator.py
...
from leakmonitor.models.finding import (
    EmailFindingResult,
    LeakFinding,
    Severity,
)
from leakmonitor.models.ransom import RansomFinding
from leakmonitor.models.report import (
    FinalReport,
    RansomwareAlerts,
    ReportMetadata,
    ReportSummary,

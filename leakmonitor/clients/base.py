...
class BaseLeakClient(ABC):
    """
    Interface abstraite pour tous les clients API de LeakMonitor.
    ...
    def __init__(self) -> None:
        ...
        self._logger = logging.getLogger(f"leakmonitor.clients.{self.name}")
    ...
    def _build_http_client(
        ...
        """
        default_headers = {
            "User-Agent": "LeakMonitor/0.1.0 (OSINT defensif — usage legitime)",
